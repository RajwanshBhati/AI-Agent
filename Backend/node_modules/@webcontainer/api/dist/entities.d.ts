...
/**
 * Functions that are exposed to scripts injected in previews
 * at the WebContainer API level with `setPreviewScript`.
 *
 * ## Example:
 *
 * ```ts
 ...
 * ```
 */
export interface WebContainerAPIWithinPreview {
    /**
     * Add an event listener to a specific event type.
     *
     * @param eventType Type of the event.
     * @param listener Listener to attach for that event.
     */
    addEventListener(eventType: 'message', listener: PreviewScriptEventListener): void;
    /**
     * Remove an event listener to a specific event type.
     *
     * @param eventType Type of the event.
     * @param listener Listener to remove.
     */
    removeEventListener(eventType: 'message', listener: PreviewScriptEventListener): void;
    /**
     * Send a new message to the WebContainer API receiver.
     *
     * @param data Data to send.
     * @param transferables An array containing all object that should be transfered as part of sending the message.
     */
    postMessage(data: any, transferables?: Transferable[]): void;
    /**
     * Interact with the previewScript storage.
     */
    readonly storage: StorageAPIWithinPreview;
}
export interface StorageAPIWithinPreview {
    /**
     * Returns the current value in storage.
     */
    get(): any;
    /**
     * Store a value that is shared between all previews.
     *
     * @param value Value to share, it will be structuredClone.
     */
     ...
     * @param listener Listener to attach for that event.
     */
    addEventListener(eventType: 'change', listener: PreviewScriptEventListener): void;
    /**
     * Remove an event listener to a specific event type.
     *
     * @param eventType Type of the event.
     * @param listener Listener to remove.
     */
    removeEventListener(eventType: 'change', listener: PreviewScriptEventListener): void;
}
export declare type PreviewScriptEventListener = (event: PreviewScriptEvent) => void;
export interface PreviewScriptEvent {
    readonly data: any;
}
/**
